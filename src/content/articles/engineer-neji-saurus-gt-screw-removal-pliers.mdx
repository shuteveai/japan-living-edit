  ...
  <div class="comparison-grid">
    <section>
      ...
      <ol class="mechanism-steps">
        <li><span>1</span><p>Driver</p></li>
        <li><span>2</span><p>Damaged recess</p></li>
        <li><span>3</span><p>Reduced engagement</p></li>
      </ol>
      <p>A screwdriver depends on usable geometry inside the screw head.</p>
    </section>
    <section>
      <h3>Pliers Approach</h3>
      <ol class="mechanism-steps">
        <li><span>1</span><p>PZ-58 jaws</p></li>
        <li><span>2</span><p>Outside of exposed screw head</p></li>
        <li><span>3</span><p>Grip and turn</p></li>
      </ol>
      <p>The PZ-58 approaches the problem by gripping the outside of an exposed screw head.</p>
    </section>
  </div>
