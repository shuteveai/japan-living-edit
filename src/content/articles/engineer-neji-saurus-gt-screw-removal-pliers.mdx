...
<aside class="mechanism-visual editorial-visual" aria-labelledby="screw-engagement-visual-title">
  <div class="mechanism-visual-header">
    <h2 id="screw-engagement-visual-title">Two Ways to Engage a Damaged Screw</h2>
    <p class="mechanism-source-note">Conceptual diagram — not to scale</p>
  </div>
  <div class="comparison-grid">
    <section>
      <h3>Driver Approach</h3>
      <div class="screw-engagement-flow" aria-label="Driver approach flow">
        <p>Driver</p>
        <span aria-hidden="true">↓</span>
        <p>Damaged recess</p>
        <span aria-hidden="true">↓</span>
        <p>Reduced engagement</p>
      </div>
      <p class="mechanism-source-note">A screwdriver depends on usable geometry inside the screw head.</p>
    </section>
    <section>
      <h3>Pliers Approach</h3>
      <div class="screw-engagement-flow" aria-label="Pliers approach flow">
        <p>PZ-58 jaws</p>
        <span aria-hidden="true">↓</span>
        <p>Outside of exposed screw head</p>
        <span aria-hidden="true">↓</span>
        <p>Grip and turn</p>
      </div>
      <p class="mechanism-source-note">The PZ-58 approaches the problem by gripping the outside of an exposed screw head.</p>
    </section>
  </div>
  <p class="visual-interpretation">Same damaged screw, different contact point.</p>
</aside>
...
<figure class="mechanism-visual editorial-visual" aria-labelledby="engineer-editorial-diagram-title">
  <div class="mechanism-visual-header">
    <h2 id="engineer-editorial-diagram-title">Damaged Screw: Change the Contact Point</h2>
    <p class="mechanism-source-note">Editorial diagram — not a product photograph.</p>
  </div>
  <img src="/assets/editorial-engineer-screw-grip.svg" width="900" height="260" loading="lazy" decoding="async" alt="Schematic showing a damaged screw recess and an outside gripping approach for a removal-specific plier role" />
  <figcaption class="visual-interpretation">This is a removal-specific role: grip an exposed outside edge when the usual drive recess no longer engages.</figcaption>
</figure>
...
This is similar to the editorial logic in our guide to [KAI 7250 Professional Fabric Shears](/articles/kai-7250-made-in-japan-professional-fabric-shears/). A professional tool becomes interesting for home use only when the home task shares the same underlying problem the tool was built to address. That same task-first approach is useful when arranging [a flexible repair zone](/articles/small-home-repair-bench-japanese-tools/) rather than leaving every tool on one permanent bench.
...
<div class="rakuten-affiliate-image-link" set:html={`<a href="https://hb.afl.rakuten.co.jp/ichiba/57ad6483.da8a7e72.57ad6484.e15f8093/?pc=https%3A%2F%2Fproduct.rakuten.co.jp%2Fproduct%2F-%2F476014ae4ae2847a72cc661825a6fa17%2F&link_type=pict&ut=eyJwYWdlIjoiaXRlbSIsInR5cGUiOiJwaWN0Iiwic2l6ZSI6IjI0MHgyNDAiLCJuYW0iOjEsIm5hbXAiOiJyaWdodCIsImNvbSI6MSwiY29tcCI6ImRvd24iLCJwcmljZSI6MCwiYm9yIjoxLCJjb2wiOjEsImJidG4iOjEsInByb2QiOjEsImFtcCI6ZmFsc2V9" target="_blank" rel="nofollow sponsored noopener" style="word-wrap:break-word;"><img src="https://hbb.afl.rakuten.co.jp/hgb/57ada49a.38726936.57ada49b.3cd23930/?me_id=1310596&item_id=10005704&pc=https%3A%2F%2Fthumbnail.image.rakuten.co.jp%2F%400_mall%2Fikitgarage%2Fcabinet%2F04263205%2Fengineer%2Fpz-58-1.jpg%3F_ex%3D240x240&s=240x240&t=pict" border="0" style="margin:2px" alt="" title=""></a>`} />
<figcaption>Rakuten affiliate image for the ENGINEER Neji-Saurus GT PZ-58 listing.</figcaption>
</figure>
